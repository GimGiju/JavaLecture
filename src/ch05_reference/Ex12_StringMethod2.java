...
public class Ex12_StringMethod2 {
	...
	public static void main(String[] args) {
		...
		/* 대소문자 변경 */
		System.out.println(str1.toUpperCase());   //  toUpperCase는 대문자 .toLowerCase는 소문자
		
		/* 문자열 대치(replace) */
		String str3 = str2.replace("안녕하세요", "안녕").replace("반갑습니다", "방가방가");
		System.out.println(str3);   // 안녕? 방가방가.
		System.out.println(str3.replace("방가", "하이")); //안녕? 하이하이.  .replace 은 글자를 바꿔줌
		// 정규표현식 사용 가능
		...
		System.out.println(now);   //2024-01-17T14:27:18.836703800 소주점까지 나옴
		...
		/* 문자열을 분할해서 배열(array) 로 반환 */
	    String fruitStr = "감, 배, 귤, 밤";
	    String[] fruits = fruitStr.split(", ");   // 감, 배, 귤, 밤 에서 ,만 제거
	    System.out.println(Arrays.toString(fruits));
	    
	    fruitStr = "감, 배; 귤: 밤";
	    fruits = fruitStr.split("[,;:]"); // 정규표현식 사용 가능. 감, 배; 귤: 밤 에서 [,;:]로 입력하면 ,;: 다 제거
	    System.out.println(Arrays.toString(fruits));
	    
	    // PATH  
	    String pathStr = "C:\\Program Files\\Common Files\\Oracle\\Java\\javapath;C:\\WINDOWS\\system32;C:\\WINDOWS;C:\\WINDOWS\\System32\\Wbem;C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\;C:\\WINDOWS\\System32\\OpenSSH\\;C:\\Program Files\\Bandizip\\;C:\\Program Files\\Git\\cmd;C:\\Program Files\\nodejs\\;C:\\Users\\human-21\\AppData\\Local\\Microsoft\\WindowsApps;;C:\\Users\\human-21\\AppData\\Local\\Programs\\Microsoft VS Code\\bin;C:\\Users\\human-21\\AppData\\Roaming\\npm";
	    String[] pathArray = pathStr.split(";");
	    for (String path: pathArray)
	    	System.out.println(path.replace("\\","/" ));
	    
	    /* 문자열 배열(array)를 하나의 문자열로 생성*/
	    System.out.println(String.join(", ", "감, 배; 귤: 밤".split("[,;:]")));
	    							// join(", " 는 감, 배; 귤: 밤 이 출력될때 감,  배,  귤,  밤 으로 출력되게 해줌
	    							// 배열 사이에 , 를 추가한다고 생각 하면됨. " -:- " 를 넣으면 감 -:- 배 -:- 귤 -:- 밤 으로 출력
