...
public class MelonChartService {
	List<MelonChart> getTop100() throws IOException{
		...
		String title = tr.selectFirst(".ellipsis.rank01").text().strip();
		String artist = tr.selectFirst(".ellipsis.rank02").text().strip();
		String album = tr.selectFirst(".ellipsis.rank03").text().strip();   
