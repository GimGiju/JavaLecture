...
public class Ex02_Primitive {
	...
	public static void main(String[] args) {
		...
		/*
		 * 정수 계열
		 * 		1. byte:  1 바이트, -123 ~ 127까지
		 *      2. short: 2 바이트, -32768 ~ 32767
		 *      3. int:   4 바이트, -2147483648 ~ 2147483647
		 *      4. long:  8 바이트, -2**63 ~ 2**63 -1  (2**63 2의 63승)
		 * 주의 사항
		 * 		- 숫자값(literal)(dP, -123, 57)은 기본적으로 int 타입
		...
		int y = 1000000;
		long z = 300000000L;
		System.out.printf("%d, %d, %d, %d\n", w, x, y, z);  // format, d는 정수, f는 실수, s는 문자열
		 ...
		 *  		- float 타입의 숫자값 뒤에는 F를 붙여야함(3.14F) 
		 */
		float f1 = 1.0000001F, f2 = 1.00000001F;
		double d1 = 1.000000000000001, d2 = 1.0000000000001;
