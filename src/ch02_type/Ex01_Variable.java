...
public class Ex01_Variable {
	...
	public static void main(String[] args) {
		int age;			// 
		age = 21;			// age, score는 정수형 정수형*정수형 = 정수형
		...
		if (age >= 19) {
			...
			int num = 5;
			System.out.println(num);		// 변수가 선언된 블록 안이기 때문에 num이 사용 가능, 중괄호(블록) 안의 num를 의미해서 5
		}
		System.out.println(num);		// num 변수가 유효하지 않음 ( 제일 위에 num을 의미해서 2)
	}
