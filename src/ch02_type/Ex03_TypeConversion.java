...
public class Ex03_TypeConversion {
	...
	public static void main(String[] args) {
		...
		float d = c;
		double e = d;
		System.out.printf("%d, %d, %.1f, %.1f%n", b, c, d, e );   // %.1f는 소수점 첫째자리까지
		
		/*
		 * 강제 타입변환(Casting): 큰 것에서 작은 것으로 갈 경우, 표기 가능한 범위를 벗어나면 불가
		 */
		long f = 250L;
		int g = (int) f;
		short h = (short) g;  //여기까지 캐스팅
		double i = 3.14;
		double j = (float) i; // 더블 캐스팅
